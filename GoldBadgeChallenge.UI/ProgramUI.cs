...
public class ProgramUI
{
    ...
    private void RunApplication()
    {
        ...
        while (isRunning)
        {
            ...
            "2. Get All Enroute Deliveries\n" +
            "3. Get All Completed Deliveries\n" +
            "4. Get Delivery by Customer ID\n" +
            "5. Add Delivery\n" +
    ...
    private void SeedDeliveries()
    {
        ...
        _dRepo.UpdateStatusType(delivery1, ds1);

        DateTime od2 = new DateTime(2023, 5, 7);
        ...
        _dRepo.UpdateStatusType(delivery2, ds2);
        ...
        _dRepo.UpdateStatusType(delivery3, ds3);
    }
    ...
    private void DeleteDelivery()
    {
        ...
        WriteLine("Please enter the ID of the Delivery to be Deleted");
        var userInput = int.Parse(ReadLine()!);
        bool isDeleted = _dRepo.DeleteDelivery(userInput);
        if (isDeleted)
        {
            WriteLine("Successfully Deleted Delivery");
        }
        else
        {
            WriteLine("Failed to Delete Delivery");
        }
    ...
    private void UpdateDeliveryStatus()
    {
        ...
        switch (userInputStatusId)
        {
            case 1:
                ...
                _dRepo.UpdateStatusType(delivery, status);
                break;
            case 2:
